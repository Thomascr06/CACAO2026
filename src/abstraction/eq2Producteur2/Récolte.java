...
public class Récolte extends Producteur2Acteur {
    ...
    /**
     * Certifie un pourcentage des parcelles F_HQ en F_HQ_E avec conditions équitables
     * Divise les plantations en partie certifiée et non-certifiée
     * 
     * @param pourcentageACertifier : pourcentage de parcelles HQ à certifier (0.0 à 100.0)
     * @param nombreOuvriers : nombre d'ouvriers minimum par parcelle
     * @param salaireMini : salaire minimum journalier en euros
     * @param coutLabel : coût du label en euros par mois (tous les 2 next)
     */
    public void certifierPlantationsEquitable(double pourcentageACertifier, int nombreOuvriers, double salaireMini, double coutLabel) {
        ...
        if (plantationsHQATraiter.isEmpty()) {
            JournalBanque.ajouter(Filiere.LA_FILIERE.getEtape()+" : Aucune plantation HQ disponible pour certification");
            return;
        }
        ...
        for (Plantation plantationHQ : plantationsHQATraiter) {
            ...
            if (plantationNonCertifiee != null) {
                ...
                Journalterrains.ajouter(Filiere.LA_FILIERE.getEtape()+" : Plantation divisée - "+totalParcellesCertifiees+" certifiées (équitable), "+totalParcellesNonCertifiees+" non-certifiées");
            }
        }
        
        JournalBanque.ajouter(Filiere.LA_FILIERE.getEtape()+" : Certification équitable - "+pourcentageACertifier+"% des parcelles HQ | Certifiées: "+totalParcellesCertifiees+" | Non-certifiées: "+totalParcellesNonCertifiees);
    }
